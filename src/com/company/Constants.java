...
public abstract class Constants {
    ...
    public static final int SPAWN_FOR_HERO = 250;
    public static final int SPAWNx_FOR_FLOOR = 0;
    public static final int SPAWNy_FOR_FLOOR = Constants.minY+60;
    public static final int SPAWNy_FOR_BLOCK = HEIGHT - 210;
    ...
    public static final double FREQUENCY_FOR_FLOOR = 0;
